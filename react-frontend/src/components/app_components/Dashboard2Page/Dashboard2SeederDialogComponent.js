...
import seederData from "./dashboard2.seeder.json";
...
const Dashboard2SeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(Dashboard2SeederDialogComponent);
