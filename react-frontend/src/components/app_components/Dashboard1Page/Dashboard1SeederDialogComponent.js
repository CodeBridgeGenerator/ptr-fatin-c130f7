...
import seederData from "./dashboard1.seeder.json";
...
const Dashboard1SeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(Dashboard1SeederDialogComponent);
