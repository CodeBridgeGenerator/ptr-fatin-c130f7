...
import SingleDashboard1Page from "../components/app_components/Dashboard1Page/SingleDashboard1Page";
import Dashboard1ProjectLayoutPage from "../components/app_components/Dashboard1Page/Dashboard1ProjectLayoutPage";
import SingleDashboard2Page from "../components/app_components/Dashboard2Page/SingleDashboard2Page";
import Dashboard2ProjectLayoutPage from "../components/app_components/Dashboard2Page/Dashboard2ProjectLayoutPage";
//  ~cb-add-import~
  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute redirectPath={"/login"} />}>
        ...
        />
<Route path="/dashboard1/:singleDashboard1Id" exact element={<SingleDashboard1Page />} />
<Route path="/dashboard1" exact element={<Dashboard1ProjectLayoutPage />} />
<Route path="/dashboard2/:singleDashboard2Id" exact element={<SingleDashboard2Page />} />
<Route path="/dashboard2" exact element={<Dashboard2ProjectLayoutPage />} />
