...
const dashboard1 = require("./dashboard1/dashboard1.service.js");
const dashboard2 = require("./dashboard2/dashboard2.service.js");
...
module.exports = function (app) {
  ...
  app.configure(dashboard1);
  app.configure(dashboard2);
